            ...
            <dl
                ...
                <div>
                    <dt>
                        ...
                        <p class="mt-5 text-lg leading-6 font-medium text-gray-900">Immatriculations des Immeubles</p>
                    </dt>
                ...
                <div>
                    <dt>
                        ...
                        <p class="mt-5 text-lg leading-6 font-medium text-gray-900">Opérations Comptables</p>
                    </dt>
                    <dd class="mt-2 text-base text-gray-500">
                ...
                <div>
                    <dt>
                        ...
                        <p class="mt-5 text-lg leading-6 font-medium text-gray-900">Delivrance de Renseignements</p>
                    </dt>
                    <dd class="mt-2 text-base text-gray-500">
                ...
                <div>
                    <dt>
                        ...
                        <p class="mt-5 text-lg leading-6 font-medium text-gray-900">Tenue du fichiers immobiliers</p>
                    </dt>
                    <dd class="mt-2 text-base text-gray-500">
                        Veniam necessitatibus reiciendis fugit explicabo dolorem nihil et omnis assumenda odit? Quisquam
                        unde accusantium.
                    </dd>
                </div>
            </dl>
